...
class ChatReportReasonUnrelatedLocation extends ChatReportReason {
  ...
  @override
  ChatReportReasonUnrelatedLocation copyWith() =>
      const ChatReportReasonUnrelatedLocation();
...
class ChatReportReasonFake extends ChatReportReason {
  ...
  /// Parse from a json
  factory ChatReportReasonFake.fromJson(Map<String, dynamic> json) =>
      const ChatReportReasonFake();
...
class ChatReportReasonIllegalDrugs extends ChatReportReason {
  ...
  /// Parse from a json
  factory ChatReportReasonIllegalDrugs.fromJson(Map<String, dynamic> json) =>
      const ChatReportReasonIllegalDrugs();
  ...
  @override
  ChatReportReasonIllegalDrugs copyWith() =>
      const ChatReportReasonIllegalDrugs();
...
class ChatReportReasonPersonalDetails extends ChatReportReason {
  ...
  /// Parse from a json
  factory ChatReportReasonPersonalDetails.fromJson(Map<String, dynamic> json) =>
      const ChatReportReasonPersonalDetails();
  ...
  @override
  ChatReportReasonPersonalDetails copyWith() =>
      const ChatReportReasonPersonalDetails();
